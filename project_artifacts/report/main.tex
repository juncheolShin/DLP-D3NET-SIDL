...
또한 D3Net 원 논문은 AirNet, PromptIR, IDR, InstructIR 등 기존 all-in-one restoration 방법과의 비교를 통해 D3Net의 frequency-domain prompt와 dynamic decomposition 설계가 평균 성능과 계산량 측면에서 경쟁력이 있음을 보고하였다 \cite{wang2025d3net}.
...
\section{Results}
\input{tables/allinone_comparison.tex}
...
이 표의 목적은 D3Net이 기존 all-in-one 방법 대비 frequency-domain cue와 dynamic decomposition을 통해 degradation-adaptive backbone으로 설계되었음을 보여주는 것이다.
